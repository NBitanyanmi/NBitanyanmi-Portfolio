...
const Home = () => {
  return (
    <section id="home" className="min-h-screen flex flex-col items-center justify-center text-center bg-gray-900 text-white">
      <motion.img
        src="/assets/Justice.jpg"
        alt="Profile"
        className="profile-image" // Use CSS instead of Tailwind
      ...
      <h1 className="text-3xl md:text-5xl font-bold mt-4">
        Hi, I'm <span className="text-blue-400">N-nyiimock Bitanyanmi</span>
      </h1>
